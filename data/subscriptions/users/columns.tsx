...
export const subscriptionsColumns: ColumnDef<SubscriptionType>[] = [
  {
  ...
  },
  {
    ...
    header: "Duration",
    cell: ({ row }) => (
      <div className="text-white">{row.getValue("duration")}</div>
    ),
  },
  {
    accessorKey: "price",
    header: "Price",
    cell: ({ row }) => (
      <div className="text-white">{row.getValue("price")}</div>
    ),
  },
  {
    accessorKey: "status",
